...
namespace Gateway.Login
{
    public static class LoginManager
    {
        ...
        [SOEMessageHandler("PacketLogin", (ushort)ClientGatewayBasePackets.PacketTunneledClientPacket, "CGAPI_527")]
        ...
        [SOEMessageHandler("PacketLogin", (ushort)ClientGatewayBasePackets.PacketTunneledClientWorldPacket, "CGAPI_527")]
        public static void HandleTunneledClientWorldPacket(SOEClient soeClient, SOEMessage soeMessage)
        {
            ...
            _log.Info($"HandleTunneledClientWorldPacket OpCode: {BitConverter.ToInt16(data, 0)}");
        }
        ...
        public static void HandleLoginRequest(SOEClient soeClient, SOEMessage message)
        {
            ...
            UpdateStats.SendAbilityPacketAbilityDefinition(soeClient);
            ...
            SendTunneledClientPacket(soeClient, StringToByteArray(""));
            SendTunneledClientPacket(soeClient, StringToByteArray("D1000200000000000000"));
        ...
        public static void SendLoginReply(SOEClient soeClient)
        {
            ...
            var rawBytes = loginReply.GetRaw();
        ...
        public static void SendInitializationParameters(SOEClient soeClient)
        {
            ...
            var rawBytes = initializationParameters.GetRaw();
        ...
        public static void SendZoneDetails(SOEClient soeClient)
        {
            ...
            var rawBytes = zoneDetails.GetRaw();
        ...
        public static void SendClientGameSettings(SOEClient soeClient)
        {
            ...
            var rawBytes = clientGameSettings.GetRaw();
        ...
        public static void SendAnnouncementData(SOEClient soeClient)
        {
            ...
            rawBytes = announcementBase.GetRaw();
        ...
        public static void SendClientBeginZoning(SOEClient soeClient)
        {
            ...
            //beginZoning.AddFloat(365.125812f); // X
            /* Merry Vale Spawn */
            //beginZoning.AddFloat(-1175.521412f); // Y
            //beginZoning.AddFloat(-35.529778f); // Z
            //beginZoning.AddFloat(-430.532132f); // X
            /* Sunstone Valley Spawn */
            //beginZoning.AddFloat(500f); // Y
            //beginZoning.AddFloat(71.423123f); // Z
            //beginZoning.AddFloat(1775f); // X
            /* Seaside Spawn */
            ...
            /* Lakeshore Spawn */
            //beginZoning.AddFloat(-750f); // Y
            //beginZoning.AddFloat(15f); // Z
            //beginZoning.AddFloat(900f); // X
            ...
            beginZoning.AddBoolean(false);
            beginZoning.AddBoolean(false);
            byte[] raw = beginZoning.GetRaw();
            SOEWriter tunneledClient = new SOEWriter((ushort)ClientGatewayBasePackets.PacketTunneledClientPacket, true);
            tunneledClient.AddBoolean(false);
            tunneledClient.AddHostUInt32((uint)raw.Length);
            tunneledClient.AddBytes(raw);
            soeClient.SendMessage(tunneledClient.GetFinalSOEMessage(soeClient));
        }
        ...
        public static void SendPacketZoneDoneSendingInitialData(SOEClient soeClient)
        {
            ...
            var rawBytes = zoneDoneSendingInitialData.GetRaw();
        ...
        public static void SendAchievementObjectiveActivated(SOEClient soeClient)
        {
            var baseAchievement = new SOEWriter((ushort)BasePackets.BaseAchievementPacket, true);

            baseAchievement.AddHostUInt32((ushort)BaseAchievementPackets.AchievementObjectiveActivatedPacket);

            baseAchievement.AddHostUInt32(67);
            baseAchievement.AddHostUInt32(1821);
            baseAchievement.AddHostUInt32(0);
            baseAchievement.AddHostUInt32(20);
            baseAchievement.AddHostUInt32(0);
            baseAchievement.AddBoolean(true);

            var rawBytes = baseAchievement.GetRaw();
        ...
        public static void SendPacketMOTD(SOEClient soeClient)
        {
            ...
            var tunneledClient = new SOEWriter((ushort)(ushort)ClientGatewayBasePackets.PacketTunneledClientPacket, true);
        ...
        {
            var packet = new SOEWriter((ushort)BasePackets.PacketClientIsReady, true);
