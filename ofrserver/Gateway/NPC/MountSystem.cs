...
{
    internal class MountSystem
    {
        public static void HandlePacketMount(SOEClient client, SOEReader reader)
        {
        ...
        public static void SendPacketMountResponse(SOEClient soeClient, int guid)
        {
            ...
            var mountItem = LoginManager.PlayerData.ClientItems.Find(cItem => cItem.Definition == mountList.MountGUID);
            var mountItemDef = LoginManager.ClientItemDefinitions.Find(mItemDef => mItemDef.Id == mountItem.Definition);
            ...
            addMount.AddHostInt64(LoginManager.PlayerData.PlayerGUID + 1000); // MountGuid
            addMount.AddHostInt32(mountList.MountName); // Name ID
            addMount.AddHostInt32(mountList.MountId); // Model ID
            ...
            mountResponse.AddHostInt64(LoginManager.PlayerData.PlayerGUID + 1000); // MountGuid
        ...
        public static void SendPacketDismountResponse(SOEClient soeClient)
        {
            ...
            removeMount.AddHostInt64(LoginManager.PlayerData.PlayerGUID + 1000); // MountGuid
